...
const Input:FC<IInput> = ({inputRef,onKeyPress,title, link, type,value,setValue, placeholder, description, incorrect, disabled}) => {
    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.inputBlock}>
                <input
                    type={inputType}
                    className={classnames(style.inputBlock__input, {
                        [style.inputBlock__input_border_red]: incorrect
                    })}
                    disabled={!!disabled}
                    ref={inputRef}
                    value={value}
                ...
                {type === 'password' &&
                    <button
                        className={style.inputBlock__button}
