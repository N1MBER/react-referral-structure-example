...
const DatePicker:FC<IDatePicker> = ({title, defaultValue, onChooseDate, description, incorrect}) => {
            ...
            <div className={style.container}>
                <button
                    className={classnames(style.dateButton, {
                        [style.dateButton_incorrect]: incorrect,
                        [style.dateButton_open]: openDate
                    })}
                    onClick={() => setOpenDate(!openDate)}
                >
                    <p className={classnames(style.dateButton__text, {
                        [style.dateButton__text_empty]: !date
                    })}>
