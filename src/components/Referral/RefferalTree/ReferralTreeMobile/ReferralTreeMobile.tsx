...
import style from './referral_tree_mobile.module.scss';
...
const ReferralTreeMobile:FC<IReferralTreeMobile> = ({user, isChild, calcHeight, close, setLine, depth}) => {
    ...
    return (
        <div
            className={classNames(style.dropDown,{
                ...
                [style.dropDown_is_child]: isChild
            })}
        >
            <button className={style.dropDownButton} onClick={() => {
               ...
               <div className={style.dropDownButton__content}>
                        <div className={style.imageContainer}>
                            {user && user.image ?
                                <img
                                    className={style.imageContainer_image}
                                    src={user.image}
                                    alt={'avatar'}
                                />:
                                <p className={style.imageContainer_text}>
...
export default ReferralTreeMobile;
